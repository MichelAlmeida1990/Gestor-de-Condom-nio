...
const seedData = () => {
  ...
  if (notifCount === 0) {
    db.prepare("INSERT INTO notifications (title, message, date) VALUES (?, ?, ?)").run(
      "Bem-vindo ao CondoTrust",
      "O sistema de gestão do condomínio está ativo. Use este mural para comunicados oficiais, assembleias e avisos importantes para todos os moradores.",
